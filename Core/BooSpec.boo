# BooSpec - based on RSpec.  This is VERY much a work-in-progress.  I might
# change the syntax to be more stylistically Python or Boo like.  I might
# also rework a great deal of the interior.  I am sure I missed important
...
#				  
#
# TODO: make it more Python/Boo like, no semi-colors, 
#   use do: block (however that works)
